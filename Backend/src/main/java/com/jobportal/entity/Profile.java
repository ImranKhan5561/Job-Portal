...
@Document(collection = "profiles")
    ...
    public Profile(Long id, String name, String email, String jobTitle, String company, String location, String about, byte[] picture,Long totalExp, List<String> skills, List<Experience> experiences, List<Certifications> certifications, List<Long> savedJobs) {
        this.id = id;
        this.name = name;
        this.email = email;
